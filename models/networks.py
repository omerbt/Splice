...
def define_G(init_type='normal', init_gain=0.02, upsample_mode='nearest', downsample_mode='stride'):
    net = skip(need_sigmoid=True, upsample_mode=upsample_mode, downsample_mode=downsample_mode)
