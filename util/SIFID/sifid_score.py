...
parser.add_argument('--path2real', default='tiger/real', type=str, help=('Path to the real images'))
parser.add_argument('--path2fake', default='tiger/fake', type=str, help=('Path to generated images'))
